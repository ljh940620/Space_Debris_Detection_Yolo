...
# 최종 결과 이미지를 저장할 폴더
OUTPUT_DIR = os.path.join(PROJECT_ROOT, 'prediction_comparison_results')
...
def compare_predictions():
    ...
    for results in tqdm(results_generator, total=len(image_files), desc="이미지 처리 중"):
        ...
        # 텍스트 추가
        cv2.putText(combined_image, "Ground Truth", (10, 35), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (255, 255, 255), 2)
